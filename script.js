...
const translations = {
  en: {
    ...
    "projects.heading":
      "Practical finance and automation projects built around cleaner data, better workflows, and clearer decisions.",
    ...
    "projects.featured.link": "View project repo",
    "projects.dashboard.imageAlt": "Financial Dashboard workbook screenshot",
    "projects.dashboard.meta1": "Project 02",
    "projects.dashboard.meta2": "Excel + Portfolio Analytics",
    "projects.dashboard.title": "Financial Dashboard",
    "projects.dashboard.text":
      "An Excel portfolio analysis workbook that turns transactions, asset data, and market prices into holdings calculations, validation checks, allocation charts, and a finished performance dashboard.",
    "projects.dashboard.tag1": "Financial modeling",
    "projects.dashboard.tag2": "Excel dashboard",
    "projects.dashboard.tag3": "Data validation",
    "projects.dashboard.link": "View case study",
  ...
  es: {
    ...
    "projects.heading":
      "Proyectos prácticos de finanzas y automatización construidos alrededor de datos más limpios, mejores flujos de trabajo y decisiones más claras.",
    ...
    "projects.featured.link": "Ver repositorio",
    "projects.dashboard.imageAlt": "Captura del libro Financial Dashboard",
    "projects.dashboard.meta1": "Proyecto 02",
    "projects.dashboard.meta2": "Excel + análisis de portafolio",
    "projects.dashboard.title": "Financial Dashboard",
    "projects.dashboard.text":
      "Un libro de análisis de portafolio en Excel que convierte transacciones, datos de activos y precios de mercado en cálculos de posiciones, validaciones, gráficos de asignación y un dashboard de rendimiento terminado.",
    "projects.dashboard.tag1": "Modelado financiero",
    "projects.dashboard.tag2": "Dashboard en Excel",
    "projects.dashboard.tag3": "Validación de datos",
    "projects.dashboard.link": "Ver caso de estudio",
